...
prey$prey_category[i]
```
Compare to the list of prey categories that exist:
...
```{r}
all_stations = read.csv("raw_files/station_lookup.csv")
...
no_station_info = anti_join(full_matrix, all_stations, by = c("project", "station")) %>% 
